...
if __name__ == "__main__":
    image_dir = "img"
    json_path = "data/optimized_data.json"
    ...
    save_dir = "./data/optimized_chessboard_3d"
    ...
    with open(FileName.optimized_world_coordinates_data, "w") as f:
        json.dump(world_coordinates_data, f, cls=ExtendedEncoder, indent=4)
    print(f"Saved to {FileName.optimized_world_coordinates_data}")